  ...
  const columns = [
    {
      ...
      links: [
        ...
        { href: localizedPath(lang, "anomalies"), label: isZhLocale(lang) ? "异象图鉴" : "Anomalies" },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { href: localizedPath(lang, "quests"), label: isZhLocale(lang) ? "任务攻略" : "Quests" },
        { href: localizedPath(lang, "lore"), label: t(lang, "site.nav.lore") },
        { href: localizedPath(lang, "multiplayer"), label: isZhLocale(lang) ? "多人联机" : "Multiplayer" },
        { href: localizedPath(lang, "gameplay"), label: isZhLocale(lang) ? "玩法概览" : "Gameplay" },
        { href: localizedPath(lang, "porsche-collab"), label: isZhLocale(lang) ? "保时捷联动" : "Porsche Collab" },
      ],
    },
    {
      ...
      links: [
        ...
        { href: localizedPath(lang, "voice-actors"), label: isZhLocale(lang) ? "声优一览" : "Voice Actors" },
        { href: localizedPath(lang, "api"), label: "API" },
