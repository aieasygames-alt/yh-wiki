  ...
  if (!open) {
    return (
      ...
      >
        ...
        <span className="hidden md:inline">{t(locale, "search.placeholder")}</span>
        <kbd className="hidden md:inline text-[10px] px-1.5 py-0.5 rounded bg-gray-700 text-gray-500 border border-gray-600">
