...
export function Header() {
  ...
  const navItems: NavItem[] = [
    ...
    { type: "dropdown", key: "database", label: t(lang, "site.nav.database"), items: [
      ...
      { href: localizedPath(lang, "compare/nte-vs-zzz"), label: "NTE vs ZZZ" },
      { href: localizedPath(lang, "compare/nte-vs-ananta"), label: "NTE vs Ananta" },
      { href: localizedPath(lang, "compare/nte-vs-honkai-star-rail"), label: "NTE vs Star Rail" },
      { href: localizedPath(lang, "compare/nte-gacha-vs-competitors"), label: isZhLocale(lang) ? "抽卡系统对比" : "Gacha Comparison" },
